/* ============================================================
   ...
   Purpose:
   Perform performance-focused analysis including:
...
/* ------------------------------------------------------------
   1) Product Performance vs Average (per product)
------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   2) Year-over-Year (YoY) Sales Comparison (per product)
------------------------------------------------------------ */
WITH yearly_product_sales AS (
    SELECT
        YEAR(f.order_date) AS order_year,
...
/* ------------------------------------------------------------
   3) Part-to-Whole: Category Contribution to Total Sales
------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   4) Product Segmentation Summary (by cost ranges)
------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   5) Customer Segmentation Summary (VIP / Regular / New)
------------------------------------------------------------ */
